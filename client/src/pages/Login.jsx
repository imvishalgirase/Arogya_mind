  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-73px)] bg-gray-50 dark:bg-slate-950 p-4">
      <div className="w-full max-w-md p-8 bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-800">
        ...
        <p className="text-center text-gray-500 dark:text-gray-400 mb-8">Sign in to your Arogya Mind account</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" disabled={loading} className="w-full py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:opacity-70 text-white font-medium rounded-xl shadow-md transition-colors flex items-center justify-center">
